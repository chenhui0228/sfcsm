...
angular.module('bucketApp', ['ngRoute','ui.bootstrap','SfcsmCommons'])
...
function refreshBuckets($http, $scope) {
    $http({method: "get", url: sfcsmCtrlURL + "S3/bucket", data:"stats=False"}).
...
function DetailCtrl($rootScope,$scope, $http, $routeParams, $route, $dialogs) {
    var uri = sfcsmCtrlURL + "S3/bucket/"+$routeParams.bucketName ;
...
function DeleteCtrl($scope, $http, $routeParams, $location, $dialogs) {
    ...
    $scope.uri = sfcsmCtrlURL + "S3/bucket/" + $scope.bucketName  ;
...
function ChangeOwnerCtrl($rootScope, $scope, $routeParams, $location, $http, $dialogs) {
    ...
    $scope.changeOwner = function () {
        $scope.code = "";
        $scope.response = "";
        $scope.uri = sfcsmCtrlURL + "S3/bucket/"+$scope.bucketName+"/link";
...
function CreateCtrl($rootScope, $scope, $routeParams, $location, $http, $dialogs) {
    ...
    $scope.create = function () {
        $scope.code = "";
        $scope.response = "";
        $scope.uri = sfcsmCtrlURL + "S3/bucket";
